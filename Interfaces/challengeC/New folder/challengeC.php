<?php
    ...
    $sql =("SELECT what_about, how_it_works, when_it_works FROM idea WHERE  member_id = 1  ORDER BY id DESC ");


    $sq =("SELECT * FROM idea WHERE  member_id = 1  ORDER BY session DESC LIMIT 1");
        ...
        <div  style="min-width: 1200px; margin: 0 auto; max-height: 1080px;">
                <div class="left" >
                    ...
                    <div class="container" >
                        ...
                        <form method="post" action="insertionC.php" id="myform">
                ...
                function updateClock(){
                    ...
                    if(t.total==0){
                       ...
                       // window.location.href = 'logout.php';
                        ...
                        window.location.href="challengeC.php";
                    }else if(t.total<0){
                        resetValues();
                        clearInterval(timeinterval);
                       // window.location.href = 'logout.php';
